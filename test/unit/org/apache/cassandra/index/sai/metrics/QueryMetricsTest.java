...
public class QueryMetricsTest extends AbstractMetricsTest
{
    ...
    public void testMetricRelease() throws Throwable
    {
        ...
        assertThatThrownBy(() -> getTableQueryMetrics(keyspace, table, "TotalQueriesCompleted")).isInstanceOf(InstanceNotFoundException.class);
    }
    ...
    private long getPerQueryMetrics(String keyspace, String table, String metricsName) throws Throwable
    {
        return (long) getMetricValue(objectNameNoIndex(metricsName, keyspace, table, PER_QUERY_METRIC_TYPE));
    }

    private long getTableQueryMetrics(String keyspace, String table, String metricsName) throws Throwable
    {

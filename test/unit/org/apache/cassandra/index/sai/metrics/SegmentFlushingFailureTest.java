...
public abstract class SegmentFlushingFailureTest extends SAITester
{
    ...
    private static final Injections.Counter memoryTrackingCounter =
            Injections.newCounter("memoryTrackingCounter").add(InvokePointBuilder.newInvokePoint()
                                               .onClass(NamedMemoryLimiter.class)
                                               .onMethod("increment")
                                               .atEntry()).build();

    private static final Injections.Counter writerAbortCounter =
            Injections.newCounter("writerAbortCounter").add(InvokePointBuilder.newInvokePoint()
    ...
    private long getSegmentBufferSpaceLimit() throws Exception
    {
    ...
    private Object getSegmentBufferUsedBytes() throws Exception
    {
        ObjectName usedBytesName = bufferSpaceObjectName("SegmentBufferSpaceUsedBytes");
        return getMetricValue(usedBytesName);
    }

    private Object getColumnIndexBuildsInProgress() throws Exception
    {

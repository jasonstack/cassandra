...
public class IndexesSystemViewTest extends SAITester
{
    ...
    private static final String DELETE = String.format("DELETE FROM %s.%s WHERE %s='%s' AND %s='%%s'",
                                                       ...
                                                       KEYSPACE,
                                                       IndexesSystemView.INDEX_NAME);
    private static final String SELECT = String.format("SELECT %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s " +
                                                       "FROM %s.%s WHERE %s = '%s'",
                                                       IndexesSystemView.INDEX_NAME,
    ...
    public void testVirtualTableThroughIndexLifeCycle() throws Throwable
    {
        ...
        execute(insert, 1, 10, 111, "1111");
        execute(insert, 2, 20, 222, "2222");
        flush();
        assertRows(execute(SELECT),
        ...
        assertRows(execute(SELECT), row(v1IndexName, "v1", true, false, false, 1, 3L));

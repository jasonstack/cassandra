...
public class SingleNodeQueryFailureTest extends SAITester
{
    ...
    {
        // verify multi-index query that uses TokenIntersectionFlow releases resources
        Injection injection = Injections.newCustom(name)
                                              .add(InvokePointBuilder.newInvokePoint().onClass(targetClass).onMethod(targetMethod))

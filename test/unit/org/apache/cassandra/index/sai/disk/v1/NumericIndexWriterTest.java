...
public class NumericIndexWriterTest extends NdiRandomizedTest
{
    ...
    public void shouldFlushFromRamBuffer() throws Exception
    {
        ...
        final MutablePointValues pointValues = ramBuffer.asPointValues();
        ...
        ))
        {
            ...
            }, NO_OP_BKD_LISTENER, new QueryContext()))
            {
    ...
    private TermsIterator buildTermEnum(int startTermInclusive, int endTermExclusive)
    {
        ...
        final AbstractIterator<Pair<ByteBuffer, IntArrayList>> iterator = new AbstractIterator<Pair<ByteBuffer, IntArrayList>>()
        {
            ...
            protected Pair<ByteBuffer, IntArrayList> computeNext()
            {
                ...
                return Pair.create(term, postings);
            }
        };

...
public class DiskSpaceTest extends AbstractNodeLifecycleTest
{
    ...
    public void testTableTotalDiskSpaceUsed() throws Throwable
    {
        ...
        long sstableSize = totalDiskSpaceUsed(currentTable());
        ...
        long indexSize = indexDiskSpaceUse(currentTable());
        long sstableSizeWithIndex = totalDiskSpaceUsed(currentTable());
        ...
        assertEquals(sstableSize, totalDiskSpaceUsed(currentTable()));

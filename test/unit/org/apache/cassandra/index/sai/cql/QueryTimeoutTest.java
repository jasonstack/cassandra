...
public class QueryTimeoutTest extends SAITester
{
    ...
    public void delayDuringKDTreeIntersectionShouldProvokeTimeoutInReader() throws Throwable
    {
        ...
        assertThatThrownBy(() -> executeNet(formatQuery("SELECT * FROM %s WHERE v1 >= 0 AND v1 < 10000"))).isInstanceOf(ReadTimeoutException.class);
    ...
    public void delayDuringTermsReaderMatchShouldProvokeTimeoutInReader() throws Throwable
    {
        ...
        assertThatThrownBy(() -> executeNet(formatQuery("SELECT * FROM %s WHERE v2 = '1'"))).isInstanceOf(ReadTimeoutException.class);

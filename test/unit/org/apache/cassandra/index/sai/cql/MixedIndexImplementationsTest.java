...
//    private void waitForIndexQueryable()
//    {
//        new PollingWait()
//                .pollEvery(3, TimeUnit.SECONDS)
//                .timeoutAfter(60, TimeUnit.SECONDS)
//                .until(new RunnableAssert("wait for index building")
//                {
//                    @Override
//                    public void run()
//                    {
//                        ColumnFamilyStore cfs = getCurrentColumnFamilyStore();
//                        Assert.assertNotNull(cfs.indexManager);
//                        for (Index index : cfs.indexManager.listIndexes())
//                        {
//                            Assert.assertTrue(cfs.indexManager.isIndexQueryable(index));
//                        }
//                    }
//                });
//    }

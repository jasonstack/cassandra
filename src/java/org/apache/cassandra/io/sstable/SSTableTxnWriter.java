...
public class SSTableTxnWriter extends Transactional.AbstractTransactional implements Transactional
{
                                          ...
                                          Collection<Index.Group> indexeGroups)
    {
        ...
        SSTableMultiWriter writer = SimpleSSTableMultiWriter.create(descriptor, keyCount, repairedAt, pendingRepair, isTransient, metadata, collector, header, indexeGroups, txn);
        return new SSTableTxnWriter(txn, writer);
    }

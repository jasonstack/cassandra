...
public class DatabaseDescriptor
{
    ...
    private static void applySimpleConfig()
    {
        ...
        if (conf.temporary_cache_size_in_mb == null)
            conf.temporary_cache_size_in_mb = Math.min(128, (int) (Runtime.getRuntime().maxMemory() / (16 * 1048576)));
    ...
    */
    ...
    public static int getTemporaryCacheSizeInMB()
    {
        if (conf.temporary_cache_size_in_mb == null)
        {
            // In client mode the value is not set.
        ...
        return conf.temporary_cache_size_in_mb;
    }

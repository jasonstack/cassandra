...
{
    private static final Comparator<PeekablePostingList> COMPARATOR = Comparator.comparing(PeekablePostingList::peek);
    ...
    {
        this.postingLists = new PriorityQueue<>(COMPARATOR);
        ...
        {
            this.postingLists.add(postingList.peekable());
    ...
    public static PostingList merge(List<PostingList> postings, Closeable onClose)
    {
        ...
        return postings.size() > 1 ? new MergePostingList(postings, onClose) : postings.get(0);
    }

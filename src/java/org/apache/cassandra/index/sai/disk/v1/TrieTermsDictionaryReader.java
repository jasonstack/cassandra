...
class TrieTermsDictionaryReader extends Walker<TrieTermsDictionaryReader>
{
    ...
    Iterator<Pair<ByteSource, Long>> iterator()
    {
        return new AbstractIterator<Pair<ByteSource, Long>>()
        {
            ...
            protected Pair<ByteSource, Long> computeNext()
            {
                ...
                return Pair.create(collector.toByteSource(), getCurrentPayload());
            }
    ...
    private static class TransitionBytesCollector
    {
        ...
        {
            assert pos > 0;
            return ByteSource.fixedLength(bytes, 0, pos);
        }

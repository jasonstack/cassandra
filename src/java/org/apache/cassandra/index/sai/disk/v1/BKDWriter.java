...
public class BKDWriter implements Closeable
{
     ...
     */
    public long writeField(IndexOutput out, MutablePointValues reader,
    ...
    private long writeField1Dim(IndexOutput out, MutablePointValues reader,
    ...
    private class OneDimensionBKDWriter
    {
        ...
        private void writeLeafBlock() throws IOException
        {
            ...
            final Sorter sorter = new IntroSorter()
            {
                ...
                {
                    return pivot.rowID - rowIDAndIndexes[j].rowID;
                }
            };

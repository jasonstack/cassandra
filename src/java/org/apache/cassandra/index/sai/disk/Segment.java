...
public class Segment implements Closeable
{
    ...
    @VisibleForTesting
    public Segment(LongArray.Factory tokenFactory, LongArray.Factory offsetFactory, KeyFetcher keyFetcher,
                   SSTableIndex.PerIndexFiles indexFiles, SegmentMetadata metadata)
    {
    ...
    /**
     * Search on-disk index asynchronously
     *
     ...
     */
    public RangeIterator search(Expression expression, SSTableQueryContext context)
    {

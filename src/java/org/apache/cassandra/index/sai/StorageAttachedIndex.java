...
public class StorageAttachedIndex implements Index
{
     ...
     */
    public static final long SEGMENT_BUILD_MEMORY_LIMIT = 1024L * 1024L * (long) DatabaseDescriptor.getSAISegmentWriteBufferSpace();
    ...
    public static final Set<CQL3Type> SUPPORTED_TYPES = ImmutableSet.of(CQL3Type.Native.ASCII, CQL3Type.Native.BIGINT, CQL3Type.Native.DATE,
                                                                        ...
                                                                        CQL3Type.Native.UUID, CQL3Type.Native.VARCHAR);

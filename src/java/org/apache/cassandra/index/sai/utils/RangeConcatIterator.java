 ...
 * place, to produce a new stably sorted iterator. Duplicates are eliminated later in {@link StorageAttachedIndexSearcher}
...
public class RangeConcatIterator extends RangeIterator
{
    ...
    protected RangeConcatIterator(RangeIterator.Builder.Statistics statistics, PriorityQueue<RangeIterator> ranges)
    {
        ...
        this.ranges = ranges;
        this.toRelease = new ArrayList<>(ranges.size());
    }
    ...
    protected Token computeNext()
    {
        while (!ranges.isEmpty())
        {
            ...
            FileUtils.closeQuietly(ranges.poll());
        }
